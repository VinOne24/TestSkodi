...
<footer class="bg-gradient-to-b from-slate-50 to-slate-100">
    ...
    <div class="px-4 py-6 bg-gradient-to-b from-slate-100 to-slate-50 md:flex md:items-center md:justify-between">
