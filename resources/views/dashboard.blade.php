<x-app-layout>
                        ...
                        <div class="splide">
                          ...
                          <div class="splide__track">
                            <div class="splide__list gap-x-4">
                              <div class="w-full p-4 bg-red-50 shadow splide__slide lg:max-w-lg">
                                <div class="space-y-2">
                              ...
                              <div class="w-full p-4 shadow bg-red-50 splide__slide lg:max-w-lg">
                                <div class="space-y-2">
                                  <h3 class="text-2xl font-semibold">
    ...
    <script>
      ...
      splide.mount();
        // card apa yang mereka bilang tentang kami
        var btn_diva = document.getElementById("btn_carda");
        var btn_divb = document.getElementById("btn_cardb");
        var btn_divc = document.getElementById("btn_cardc");
        var diva = document.getElementById("divcarda");
        var divb = document.getElementById("divcardb");
        var divc = document.getElementById("divcardc");
        ...
        btn_carda.addEventListener('click', (e))=>{
            divcarda.style.display='block';
            divcardb.style.display='none';
            divcardc.style.display='none';
            activeBtnClass(e.target.id);

        }
        btn_cardb.addEventListener('click', (e))=>{
            divcarda.style.display='none';
            divcardb.style.display='block';
            divcardc.style.display='none';
            activeBtnClass(e.target.id);

        }
        btn_cardc.addEventListener('click', (e))=>{
            divcarda.style.display='none';
            divcardb.style.display='none';
            divcardc.style.display='block';
            activeBtnClass(e.target.id);

        }
        const activeBtnClass = (id=null) => {
            let btnClass = document.querySelectorAll(".btn_kelasCard");
            btnClass.forEach((i) => {
                console.log(i.id);
                if(i.id ==id){
